<div class="acp-page-container" style="max-width: 1200px;">
	<div component="settings/main/header" class="row border-bottom py-2 m-0 sticky-top acp-page-main-header align-items-center">
		...
		<div class="col-12 col-md-4 px-0 px-md-3">
			<button id="build" class="btn btn-primary btn-sm fw-semibold ff-secondary w-100 text-center text-nowrap">{{tx("admin/admin:save-changes")}}</button>
		</div>
	</div>
		...
		<div id="spy-container" class="col-12 px-0 mb-4" tabindex="0">
			<ul class="nav nav-tabs mb-3" role="tablist">
				<li class="nav-item" role="presentation">
					<button
						...
						id="template-customize-tab"
						data-bs-toggle="tab"
						data-bs-target="#template-customize-pane"
						type="button"
						role="tab"
						aria-controls="template-customize-pane"
						aria-selected="true"
					>
				...
				<li class="nav-item" role="presentation">
					<button
						...
						id="translations-customize-tab"
						data-bs-toggle="tab"
						data-bs-target="#translations-customize-pane"
						type="button"
						role="tab"
						aria-controls="translations-customize-pane"
						aria-selected="false"
					>
			...
			<div class="tab-content">
				<div class="tab-pane fade show active"
					id="template-customize-pane"
					role="tabpanel"
					aria-labelledby="template-customize-tab"
					tabindex="0">
					<div class="card">
						<table class="table">
							<thead>
				...
				<div class="tab-pane fade"
					id="translations-customize-pane"
					role="tabpanel"
					aria-labelledby="translations-customize-tab"
					tabindex="0">
					<div class="card">
						<table class="table">
						<thead>
